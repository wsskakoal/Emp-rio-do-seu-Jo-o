...
$sql = "SELECT id, Descricao, Conteudo, DataEnvio  FROM noticia";
...
<?php
 while($linha = mysqli_fetch_array($query))
 {
   ...
   echo substr('<td>'.$linha["Conteudo"], 0, 30);
   echo '<td>' . $linha['DataEnvio'] . '<br>';
   echo '<td>' . '<a href="visualizar.php?codNoticia='.$linha['id'].'"> Visualizar </a>' . '<br>';
 }
?>
</table>
<div class="">
